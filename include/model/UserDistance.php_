...
/***********************************************
 * UserDistance represents a table in jukeboxDB 
 *
 * @author  megan
 * @version 180927
 ***********************************************
 */
class UserDistance extends DBObject
{    
    public $userId=0;
    public $accountId=0;
    public $userName="";
    ...
    /******************************************************
     * Construct a UserDistance from a JSONObject.
     *
     * @param json
     *        A JSONObject.
     ******************************************************
     */
    function UserDistance($jsonString='')
    {
        //--------------------------------------------------------------------
